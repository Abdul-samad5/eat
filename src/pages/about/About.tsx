    ...
    <div>
        <div className='flex justify-around max-sm:flex max-md:flex-col'>
            <div className='mt-20 max-md:text-center'>
                ...
                <p className="w-96 text-xl max-md:text-xl">Lorem ipsum dolor sit amet consectetur. Viverra pharetra velit faucibus lacus. Nisi porta arcu laoreet pulvinar feugiat felis vel. Blandit auctor sit erat mauris proin ut egestas nisi. Enim at amet id purus enim platea eleifend lorem. Sit dignissim ac.</p>
            </div>
